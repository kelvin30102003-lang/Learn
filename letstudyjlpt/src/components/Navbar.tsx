...
export default function Navbar() {
  return <header className="border-b border-[var(--line)] bg-[var(--background)]/95 backdrop-blur">
    <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4">
      ...
      <nav className="hidden items-center gap-6 text-sm text-[var(--ink-muted)] md:flex"><Link href="/tests" className="hover:text-[var(--foreground)]">Practice</Link><Link href="/dashboard" className="hover:text-[var(--foreground)]">Dashboard</Link><Link href="/premium" className="hover:text-[var(--foreground)]">Premium</Link></nav>
